...
_Generated: 2026-08-12T13:50:57.400Z_
...
Workspace `mcp.json` _(folder: green_store)_

- **c:\xampp\htdocs\green_store\.mcp.json** — _File missing_
...
- **bigquery-ai-ml** — `C:\Users\pc\.copilot\skills\bigquery-ai-ml`
  - Leverages BigQuery's built-in machine learning and GenAI capabilities

- **bigquery-bigframes** — `C:\Users\pc\.copilot\skills\bigquery-bigframes`
  - Generates Python code using BigQuery DataFrames (BigFrames), the pandas/scikit-learn-style\

- **bigquery-data-transfer-service** — `C:\Users\pc\.copilot\skills\bigquery-data-transfer-service`
  - Discovers and inspects BigQuery Data Transfer Service (DTS) configurations.

- **bigquery-graph** — `C:\Users\pc\.copilot\skills\bigquery-graph`
  - Provides guidelines and best practices for querying and defining property

- **bigquery-sql** — `C:\Users\pc\.copilot\skills\bigquery-sql`
...
- **data-autocleaning** — `C:\Users\pc\.copilot\skills\data-autocleaning`
  - Automated data quality and transformation capabilities for Dataform/dbt/BigQuery

- **dataform-bigquery** — `C:\Users\pc\.copilot\skills\dataform-bigquery`
  - Expertise in generating clean, correct, and efficient Dataform pipeline

- **dbt-bigquery** — `C:\Users\pc\.copilot\skills\dbt-bigquery`
...
- **enforcing-resource-attribution** — `C:\Users\pc\.copilot\skills\enforcing-resource-attribution`
  - Enforces resource attribution for CLI commands. Use this skill whenever

- **federate-lakehouse-catalog** — `C:\Users\pc\.copilot\skills\federate-lakehouse-catalog`
  - Sets up Google Cloud Lakehouse federated catalogs to remote Iceberg

- **gcloud-auth-verification** — `C:\Users\pc\.copilot\skills\gcloud-auth-verification`
  - Guidelines for identifying and resolving missing Google Cloud authentication

- **gcp-composer-troubleshooting** — `C:\Users\pc\.copilot\skills\gcp-composer-troubleshooting`
  - Provides expert guidance for troubleshooting Cloud Composer (Apache

- **gcp-data-pipelines** — `C:\Users\pc\.copilot\skills\gcp-data-pipelines`
...
- **gcp-managed-airflow-migrations** — `C:\Users\pc\.copilot\skills\gcp-managed-airflow-migrations`
  - Provides guidance for migrating Apache Airflow DAGs in Managed Service

- **gcp-pipeline-orchestration** — `C:\Users\pc\.copilot\skills\gcp-pipeline-orchestration`
...
- **gcs-security-assessment** — `C:\Users\pc\.copilot\skills\gcs-security-assessment`
