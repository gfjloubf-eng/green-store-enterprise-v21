/* ============================================================
   GSDS v1.1 — SupplierEmptyState Component
   Green Store Design System — Enterprise UI Foundation
   Milestone 4.5 — Professional empty state placeholder
   ============================================================
   Pure presentation component.
   Reuses the same GSDS pattern as the Product/Inventory EmptyState.
   ============================================================ */
