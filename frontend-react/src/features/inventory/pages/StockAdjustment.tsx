/* ============================================================
   GSDS v1.1 — StockAdjustment
   Green Store Design System — Enterprise UI Foundation
   Milestone 4.4 — Stock adjustment form page
   ============================================================
   Presentational placeholder for the adjustment workflow.
    ...
    <div className="flex flex-col gap-4">
      ...
      <div>
        <h1 className="text-h2 font-semibold [color:var(--gs-foreground)] flex items-center gap-2">
          <SlidersHorizontal className="h-6 w-6 [color:var(--gs-primary)]" aria-hidden="true" />
      ...
      <div className="gsd-card p-8 text-center">
        <div className="flex flex-col items-center gap-4 py-12">
          <div className="flex h-16 w-16 items-center justify-center rounded-full [background:var(--gs-muted)]">
            <SlidersHorizontal className="h-8 w-8 [color:var(--gs-foreground-muted)]" aria-hidden="true" />
          </div>
          <h2 className="text-lg font-semibold [color:var(--gs-foreground)]">
            {t('inventory.stockAdjustment.management')}
          </h2>
          <p className="text-sm [color:var(--gs-foreground-secondary)] max-w-md">
            {t('inventory.stockAdjustment.description')}
          </p>
        </div>
      </div>
    </div>
