...
export class ReportsController {
  ...
  public async getDashboardKpis(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
  ...
  public async getSalesReport(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
    const ctx = this.createApiContext(request);
  ...
  public async getProductAnalytics(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
    const ctx = this.createApiContext(request);
  ...
  public async getInventoryAnalytics(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
    const ctx = this.createApiContext(request);
  ...
  public async getCustomerAnalytics(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
    const ctx = this.createApiContext(request);
  ...
  public async getPaymentAnalytics(request: ControllerRequest<any>): Promise<ApiResponse<any>> {
    const ctx = this.createApiContext(request);
